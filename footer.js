    ...
    <footer class="footer bg-dark text-white">
      <div class="container py-4">
        <div class="row">
          ...
          <!-- Address Block -->
          <div class="col-12 col-md-6 col-lg-4 mb-3 text-center text-md-start">
            <p class="mb-1">
              ...
              No542 New Street, Thirukkokarnam, Pudukkottai - 622005
            </p>
            <p class="mb-0">
              Landmark: Opposite Thirukkokarnam Government Hospital
            </p>
          </div>

          <!-- Email, Phone, Socials in One Row (on PC) -->
          <div class="col-12 col-md-6 col-lg-8 mb-3">
            <div class="d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center gap-3 h-100">
